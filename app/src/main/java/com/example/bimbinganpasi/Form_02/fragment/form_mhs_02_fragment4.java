...
public class form_mhs_02_fragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.form_mhs_02_fragment4, container, false);
        ...
        tv_ip1 = (TextView) v.findViewById(R.id.TVF2_fragment4_ip1);
        tv_ipk1 = (TextView) v.findViewById(R.id.TVF2_fragment4_ipk1);
        tv_ip2 = (TextView) v.findViewById(R.id.TVF2_fragment4_ip2);
        tv_ipk2 = (TextView) v.findViewById(R.id.TVF2_fragment4_ipk2);
        tv_realsks = (TextView) v.findViewById(R.id.TVF2_fragment4_realisasisks);
        tv_evalsks = (TextView) v.findViewById(R.id.TVF2_fragment4_evaluasisks);
        tv_realipk = (TextView) v.findViewById(R.id.TVF2_fragment4_realisasiipk);
        tv_evalipk = (TextView) v.findViewById(R.id.TVF2_fragment4_evaluasiipk);
        tv_parasks = (TextView) v.findViewById(R.id.TVF2_fragment4_parametersks);
        tv_paraipk = (TextView) v.findViewById(R.id.TVF2_fragment4_parameteripk);
        tv_realsks2 = (TextView) v.findViewById(R.id.TVF2_fragment4_realisasisks2);
        tv_evalsks2 = (TextView) v.findViewById(R.id.TVF2_fragment4_evaluasisks2);
        tv_realipk2 = (TextView) v.findViewById(R.id.TVF2_fragment4_realisasiipk2);
        tv_evalipk2 = (TextView) v.findViewById(R.id.TVF2_fragment4_evaluasiipk2);
        tv_parasks2 = (TextView) v.findViewById(R.id.TVF2_fragment4_parametersks2);
        tv_paraipk2 = (TextView) v.findViewById(R.id.TVF2_fragment4_parameteripk2);
        tv_catatanodd = (TextView) v.findViewById(R.id.catatansmt7);
        tv_catatanodd2 = (TextView) v.findViewById(R.id.catatan2smt7);
        tv_catataneven = (TextView) v.findViewById(R.id.catatansmt8);
        ...
        btnF2_semester8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getSemesterEven();
            }
...
//        i.putExtra("semester_min", 8);
    ...
    public void checkUserType(){
        ...
        if(mPrefs.getUserType().equals("dosen")){
            ...
            if(Integer.valueOf(mPrefs.getUserSmt()) == 6) {
                btn_smt8.removeView(btnF2_semester8);
            } else if (Integer.valueOf(mPrefs.getUserSmt()) == 7){
                btn_smt7.removeView(btnF2_semester7);
            } else {
                btn_smt7.removeView(btnF2_semester7);
                btn_smt8.removeView(btnF2_semester8);
    ...
    public class ListAdapter extends RecyclerView.Adapter<form_mhs_02_fragment4.ListAdapter.ViewHolder>
    {
        ...
        @Override
        public form_mhs_02_fragment4.ListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.form_mhs_02_cardview, parent, false);

            form_mhs_02_fragment4.ListAdapter.ViewHolder viewHolder = new form_mhs_02_fragment4.ListAdapter.ViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(form_mhs_02_fragment4.ListAdapter.ViewHolder holder, final int position)
        {
    ...
    public class ListAdapter2 extends RecyclerView.Adapter<form_mhs_02_fragment4.ListAdapter2.ViewHolder>
    {
        private ArrayList<DataNote> dataList;
        ...
        @Override
        public form_mhs_02_fragment4.ListAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.form_mhs_02_cardview, parent, false);

            form_mhs_02_fragment4.ListAdapter2.ViewHolder viewHolder = new form_mhs_02_fragment4.ListAdapter2.ViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(form_mhs_02_fragment4.ListAdapter2.ViewHolder holder, final int position)
        {
            holder.textViewMatkul.setText(dataList.get(position).getMatkul_list());
            holder.textViewSks.setText(dataList.get(position).getSks_list()+" SKS");
